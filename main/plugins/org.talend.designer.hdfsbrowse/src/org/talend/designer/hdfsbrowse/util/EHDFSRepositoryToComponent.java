...
public enum EHDFSRepositoryToComponent {
    ...
    DEFINE_PATH_TO_GOOGLE_CREDENTIALS("DEFINE_PATH_TO_GOOGLE_CREDENTIALS", "DEFINE_PATH_TO_GOOGLE_CREDENTIALS"), //$NON-NLS-1$ //$NON-NLS-2$

    PATH_TO_GOOGLE_CREDENTIALS("PATH_TO_GOOGLE_CREDENTIALS", "PATH_TO_GOOGLE_CREDENTIALS"),//$NON-NLS-1$ //$NON-NLS-2$
    
    OAUTH_ACCESS_TOKEN("OAUTH_ACCESS_TOKEN", "OAUTH_ACCESS_TOKEN"),//$NON-NLS-1$ //$NON-NLS-2$
    ...
    ADVANCED_SETTINGS_CHECK("ADVANCED_SETTINGS_CHECK", "ADVANCED_SETTINGS_CHECK"); //$NON-NLS-1$ //$NON-NLS-2$
